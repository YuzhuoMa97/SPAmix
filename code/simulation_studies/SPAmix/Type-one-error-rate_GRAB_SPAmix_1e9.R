...
# sbatch --exclude=node05,node06,node04,node03 -J 9 --mem=7000M -t 30-0:0 --array=1-90 -o log/%A_%a.log --wrap='Rscript Type-one-error-rate_GRAB_SPAmix_1e9.R $SLURM_ARRAY_TASK_ID'
...
dir.create(paste0("/gdata01/user/yuzhuoma/SPA-G/data/Type-one-error-rate_GRAB_SPAmix_1e9/Pheno.scenraio.ID-",Pheno.scenraio.ID),recursive = T)
...
for (Pheno.ID in c((Pheno.scenraio.ID-1)*Pheno.merge.number + 1:Pheno.merge.number)) {
  ...
  load(paste0("/gdata01/user/yuzhuoma/SPA-G/data/phenotype-hetero-1e6/event.rate-",ER,
  ...
  dir.create(paste0("/gdata01/user/yuzhuoma/SPA-G/data/Type-one-error-rate_GRAB_SPAmix_1e9/Pheno.scenraio.ID-",Pheno.scenraio.ID,"/Pheno.ID-",Pheno.ID),recursive = T)
  
  file.output = paste0("/gdata01/user/yuzhuoma/SPA-G/data/Type-one-error-rate_GRAB_SPAmix_1e9/Pheno.scenraio.ID-",
