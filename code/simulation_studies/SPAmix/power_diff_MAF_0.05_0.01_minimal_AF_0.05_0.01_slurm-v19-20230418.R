...
# sbatch --exclude=node05,node06 -J powerv19 --mem=4000M -t 1-0:0 --array=1-900 -o log/%A_%a.log --wrap='Rscript power_diff_MAF_0.05_0.01_minimal_AF_0.05_0.01_slurm-v19-20230418.R $SLURM_ARRAY_TASK_ID'
...
dir.create(paste0("/gdata01/user/yuzhuoma/SPA-G/power/data/power-v19-20230418-2log10MAF/Pheno.scenraio.ID-",Pheno.scenraio.ID),recursive = T)
file.output = paste0("/gdata01/user/yuzhuoma/SPA-G/power/data/power-v19-20230418-2log10MAF/Pheno.scenraio.ID-",Pheno.scenraio.ID,"/min.MAF-",min.MAF,
                     "-ER.EUR-",ER1,"-ER.EAS-",ER2,".csv")
