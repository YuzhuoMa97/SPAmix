...
# sbatch --exclude=node05 -J powerhetero --mem=4000M -t 1-0:0 --array=1-900 -o log/%A_%a.log --wrap='Rscript power_hetero_positive_slurm.R $SLURM_ARRAY_TASK_ID'
...
dir.create(paste0("/gdata01/user/yuzhuoma/SPA-G/power/5e-8/data/power_hetero_positive/GRAB_SPAmix/Pheno.scenraio.ID-",Pheno.scenraio.ID),recursive = T)
dir.create(paste0("/gdata01/user/yuzhuoma/SPA-G/power/5e-8/data/power_hetero_positive/SPACox/Pheno.scenraio.ID-",Pheno.scenraio.ID),recursive = T)
...
for (Pheno.ID in c((Pheno.scenraio.ID-1)*Pheno.merge.number + 1:Pheno.merge.number)) {
  ...
  load(paste0("/gdata01/user/yuzhuoma/SPA-G/power/data/phenotype-MAFsumover0.002-2log10MAF/event.rate-",ER,
  ...
  dir.create(paste0("/gdata01/user/yuzhuoma/SPA-G/power/5e-8/data/power_hetero_positive/GRAB_SPAmix/Pheno.scenraio.ID-",Pheno.scenraio.ID,"/Pheno.ID-",Pheno.ID),recursive = T)
  dir.create(paste0("/gdata01/user/yuzhuoma/SPA-G/power/5e-8/data/power_hetero_positive/SPACox/Pheno.scenraio.ID-",Pheno.scenraio.ID,"/Pheno.ID-",Pheno.ID),recursive = T)
  
  file.output.SPAmix = paste0("/gdata01/user/yuzhuoma/SPA-G/power/5e-8/data/power_hetero_positive/GRAB_SPAmix/Pheno.scenraio.ID-",
  ...
  # SPACox
  file.output.SPACox = paste0("/gdata01/user/yuzhuoma/SPA-G/power/5e-8/data/power_hetero_positive/SPACox/Pheno.scenraio.ID-",
