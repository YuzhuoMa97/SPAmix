...
# sbatch --exclude=node05 -J SPAmix --mem=4000M -t 1-0:0 --array=1-160 -o log/%A_%a.log --wrap='Rscript SPAmix_v1.R $SLURM_ARRAY_TASK_ID'
...
Gamma_ance1_Vec = 0 # (null ancestry)
...
for (rep in rep_List) {
  ...
  Pheno.mtx = data.table::fread(paste0("/gdata01/user/yuzhuoma/SPA-G/tractor/data/power_v1/phenotype/hetero_effect_size_scen1/prev_",prev,
                                       "/MAF_ance1_", MAF_ance1, "_MAF_ance2_", MAF_ance2,"/gamma_ance_causal_",gamma_ance2,
