...
# sbatch --exclude=node05 -J SPAmix --mem=4000M -t 1-0:0 --array=1-1032 -o log/%A_%a.log --wrap='Rscript SPAmix_CCT_v2.R $SLURM_ARRAY_TASK_ID'
...
# Gamma_ance1_Vec = c(0.2, 0.3, 0.4) # Fixed ancestry 1
...
for (rep in rep_List) {
  ...
  output_file_GRAB_SPAmix = paste0("/gdata01/user/yuzhuoma/SPA-G/tractor/data/power_v1/output/hetero_effect_size_scen2/prev_",prev,
                                   "/MAF_ance1_", MAF_ance1, "_MAF_ance2_", MAF_ance2,"/gamma_ance1_",gamma_ance1,"/gamma_ance2_",gamma_ance2,
